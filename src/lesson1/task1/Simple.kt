 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = 213.36 * sagenes + 71.12 * arshins +
        4.445 * vershoks
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = ((deg + 60 * min + 3600 * sec)* PI) / 180
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (initial*((percent%100)+1) * ((percent%100)+1) * ((percent%100)+1))
