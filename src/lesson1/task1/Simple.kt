 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * (1 + percent / 100.0) * (1 + percent / 100.0) *
        (1 + percent / 100.0)
 ...
 */
fun numberRevert(number: Int): Double = (number % 10.0) * 100 + (number / 10.0) * 10 + (number / 100.0)
